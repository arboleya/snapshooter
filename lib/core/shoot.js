  ...
  module.exports = Shoot = (function() {
    ...
    Shoot.prototype.crawl = function(url) {
      ...
      return new Crawler(this.cli, url, function(source) {
        ...
        _this.connections--;
        _this.crawled[url] = source != null ? true : false;
        if (source != null) {
    ...
    Shoot.prototype.after_crawl = function(source) {
      ...
      if (source != null) {
        while ((match = reg.exec(source)) != null) {
          ...
          if (this.url_is_passing(relative, absolute)) {
            this.crawled[absolute] = false;
    ...
    Shoot.prototype.url_is_passing = function(relative, absolute) {
      var flag, flags, not_anchor, not_crawled, not_ignore, not_image, not_pdf, not_slash, not_zip, passed, _i, _len;
      ...
      flags = [not_slash, not_crawled, not_anchor, not_image, not_zip, not_pdf, not_ignore];
      passed = true;
